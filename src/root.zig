...
pub const parser = struct {
    ...
    pub const stream_parser = @import("parser/stream_parser.zig");
};
...
pub const StreamParser = parser.stream_parser.StreamParser;
pub const parseFromReader = parser.stream_parser.parseFromReader;
pub const parseFromFile = parser.stream_parser.parseFromFile;
pub const ReaderResult = parser.stream_parser.ReaderResult;
